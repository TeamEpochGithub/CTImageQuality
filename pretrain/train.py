...
from pretrain_models.efficientnet import EfficientNetWithDecoder
...
def train(training_data, parameters, context):
    denoise_models = {"EfficientnetB0": EfficientNetWithDecoder, "Resnet34_Swin": Resnet34_Swin_Denoise,
                      "Efficientnet_Swin": Efficient_Swin_Denoise, "ResNet34": UNet34_Denoise}
    configs = {
        "pretrain": None
    }
