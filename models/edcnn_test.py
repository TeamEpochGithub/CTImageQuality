...
class EDCNN_TEST(nn.Module):

    def __init__(self, in_ch=1, out_ch=32, sobel_ch=32, nodes=32):
        super(EDCNN_TEST, self).__init__()
        ...
        self.conv_f4 = nn.Conv2d(out_ch, in_ch, kernel_size=3, stride=1, padding=1)
    ...
    def forward(self, x):
        ...
        out_4 = self.conv_f4(out_4)

        out = self.relu(x + out_4)
